...
class ConvolutionalProcessingBlockWithBNResidual(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
    ...
    def forward(self, x):
        residual = x  # Keep the input for the residual connection
...
class ConvolutionalDimensionalityReductionBlockWithBNResidual(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
    ...
    def build_module(self):
        ...
        # Dimensionality Reduction via Avg Pooling
        out = F.avg_pool2d(out, self.reduction_factor)
